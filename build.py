...
ADDRESS_OVERRIDES = {
    ...
    "Thrifty Foods (08) Colwood": ("1860 Island Hwy", "Colwood", "British Columbia", "V9B 1J2"),
    ...
    "Thrifty Foods Salt Spring": ("114 Purvis Rd", "Salt Spring Island", "British Columbia", "V8K 2S5"),
    "Market On Millstream": ("125-2401C Millstream Rd", "Langford", "British Columbia", "V9B 3R5"),
    "Market On Yates": ("903 Yates St", "Victoria", "British Columbia", "V8V 3M4"),
    ...
    "Red Barn Sidney": ("10330 McDonald Park Rd", "North Saanich", "British Columbia", "V8L 2L5"),
    "Country Bee Honey Farm": ("6440 W Saanich Rd", "Saanichton", "British Columbia", ""),
    "Deep Cove Market": ("10940 West Saanich Rd", "North Saanich", "British Columbia", "V8L 5R9"),
    ...
    "Country Grocer Cedar": ("1824 Cedar Rd #3C", "Cedar", "British Columbia", "V9X 1H9"),
    "Country Grocer - Chemanus": ("3055 Oak St", "Chemainus", "British Columbia", "V0R 1K0"),
    "Country Grocer Chemainus": ("3055 Oak St", "Chemainus", "British Columbia", "V0R 1K0"),
    "Country Grocer Cobble Hill": ("#33-1400 Cowichan Bay Rd", "Cobble Hill", "British Columbia", "V0R 1L3"),
    "Country Grocer Lake Cowichan": ("83 Lake Cowichan Rd", "Lake Cowichan", "British Columbia", "V0R 2G0"),
    "Country Grocer Bowen": ("1800 Dufferin Crescent", "Nanaimo", "British Columbia", "V9S 0A9"),
    "Country Grocer Chase River": ("82 Twelfth St", "Nanaimo", "British Columbia", "V9R 6R6"),
    "Country Grocer Saltspring": ("374 Lower Ganges Rd", "Salt Spring Island", "British Columbia", "V8K 2V7"),
    "Jollity Farm Shop & Cafe": ("2859 Oak St", "Chemainus", "British Columbia", "V0R 1K1"),
    "Fairway (Goldstream)": ("772 Goldstream Ave", "Langford", "British Columbia", "V9B 2X3"),
    "Fairway (Gorge)": ("272 Gorge Rd W", "Saanich", "British Columbia", "V9A 1M7"),
    "Fairway (Oak Bay)": ("2187 Oak Bay Ave", "Oak Bay", "British Columbia", "V8R 1G1"),
    "Fairway (Shelbourne)": ("3651 Shelbourne St", "Saanich", "British Columbia", "V8P 4H1"),
    "Fairway (Sidney)": ("2531 Beacon Ave", "Sidney", "British Columbia", "V8L 1Y1"),
    "Fairway (West Saanich)": ("7108 W Saanich Rd", "Brentwood Bay", "British Columbia", "V8M 1P8"),
    ...
    "Red Barn Market - Brookside": ("611 Brookside Rd", "Colwood", "British Columbia", "V9C 0C3"),
    "Red Barn Market (Matticks Farm)": ("129-5325 Cordova Bay Rd", "Saanich", "British Columbia", "V8Y 2L3"),
    ...
    "Red Barn - West Saanich": ("5550 W Saanich Rd", "Saanich", "British Columbia", "V9E 2G1"),
    "Red Barn - James Bay": ("325 Menzies St", "Victoria", "British Columbia", "V8V 0C3"),
    ...
    "SAVE ON Tillicum (532)": ("#108-3170 Tillicum Rd", "Saanich", "British Columbia", "V9A 7C5"),
    "SAVE ON Wilson  (403)": ("#100-172 Wilson St", "Victoria", "British Columbia", "V9A 7N6"),
    ...
    "Dan's Farm & Country Market": ("2030 Bear Hill Rd", "Saanichton", "British Columbia", "V8M 1X7"),
    "Silver Rill Corn": ("7117 Central Saanich Rd", "Central Saanich", "British Columbia", "V8M 1Y3"),
    "Co-op Food Store": ("2132 Keating Cross Rd", "Saanichton", "British Columbia", "V8M 2A6"),
    "Heart Pharmacy": ("#15-1594 Fairfield Rd", "Victoria", "British Columbia", "V8S 1G1"),
    "Nootka Rose": ("4480 Happy Valley Rd", "Metchosin", "British Columbia", "V9C 3Z3"),
    "Save on Colwood": ("#100 - 1913 Sooke Rd", "Colwood", "British Columbia", "V9B 1V9"),
    "Lifestyle Markets": ("2950 Douglas St, Unit 180", "Victoria", "British Columbia", "V8T 4N4"),
    "Lifestyle Markets Cook St.": ("343 Cook St", "Victoria", "British Columbia", "V8V 3X6"),
    "Caffe Fantastico - Harbour Rd": ("102-398 Harbour Rd", "Victoria", "British Columbia", "V9A 0B7"),
    "Great Greens": ("Suite G, 4485 Trans-Canada Hwy", "Duncan", "British Columbia", "V9L 6L8"),
    "Village Food Market (Logan Group)": ("6661 Sooke Rd", "Sooke", "British Columbia", "V9Z 0A1"),
    "Pharmasave Hillside": ("1641 Hillside Ave", "Victoria", "British Columbia", "V8T 5G1"),
    "Quadra Village Drug Mart": ("2631 Quadra St", "Victoria", "British Columbia", "V8T 4E4"),
    "Urban Grocer": ("1625 Fort St", "Victoria", "British Columbia", "V8R 1H8"),
    "Mt Douglas Market": ("4101 Shelbourne St", "Saanich", "British Columbia", "V8N 3E8"),
    "The Drake": ("517 Pandora Ave", "Victoria", "British Columbia", "V8W 3J6"),
    "Pinhalla Pizzeria": ("516 Fisgard St", "Victoria", "British Columbia", "V8W 1R4"),
}
...
TITLE_FIX = {
    ...
    "Co-op Food Store": "Peninsula Co-op Food Centre",
    "Village Food Market (Logan Group)": "Village Food Markets",
    "Nootka Rose": "Nootka Rose Milling",
    "Red Barn Brookside": "Red Barn Market (Latoria Walk)",
    "Red Barn Market - Brookside": "Red Barn Market (Latoria Walk)",
    "Red Barn Sidney": "Red Barn Market (Sandown)",
}
